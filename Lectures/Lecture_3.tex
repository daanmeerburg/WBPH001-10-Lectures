...
Now consider events that happen at the same location in frame $S$: $(\Delta t, \Delta x=0)$. In frame $S$, we can use Eq.~\eqref{eq:tLT} to find that $\Delta t = \gamma \Delta t'$. This is by definition time dilation, and according to an observer in frame $S$, a clock in frame $S'$ runs slow.
